...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: "On-demand food delivery platform built for the Saudi market",
    taglineAr: "منصة توصيل طعام عند الطلب مبنية لسوق السعودية",
    description:
      "A full-featured food delivery application similar to HungerStation — connecting customers with restaurants, enabling real-time order tracking, and delivering a seamless mobile-first experience.",
    descriptionAr:
      "تطبيق توصيل طعام متكامل مشابه لهنقرستيشن — يربط العملاء بالمطاعم، ويتيح تتبع الطلبات فورياً، ويقدم تجربة سلسة تركز على الجوال.",
    challenge:
      "Building a scalable multi-vendor marketplace with real-time order management, live delivery tracking, and a frictionless checkout experience across iOS and Android.",
    challengeAr:
      "بناء سوق متعدد البائعين قابل للتوسع مع إدارة طلبات فورية وتتبع توصيل مباشر وتجربة دفع سلسة على iOS و Android.",
    solution:
      "Developed a cross-platform mobile app with restaurant discovery, cart management, secure payments, order tracking, and a driver dispatch system — all backed by a robust real-time backend.",
    solutionAr:
      "طورت تطبيقاً متعدد المنصات مع اكتشاف المطاعم وإدارة السلة ومدفوعات آمنة وتتبع الطلبات ونظام إرسال السائقين — مدعوماً بخلفية فورية قوية.",
    architecture:
      "Flutter App → REST API → PostgreSQL → Real-time WebSockets → Payment Gateway → Push Notifications → Maps API",
    architectureAr:
      "تطبيق Flutter ← REST API ← PostgreSQL ← WebSockets فورية ← بوابة دفع ← إشعارات Push ← Maps API",
    technologies: [
      "Flutter",
      "Dart",
      "Node.js",
    ...
    businessImpact:
      "Enabled local restaurants to reach thousands of customers digitally, processing hundreds of daily orders with 98% on-time delivery rate.",
    businessImpactAr:
      "مكّن المطاعم المحلية من الوصول لآلاف العملاء رقمياً، مع معالجة مئات الطلبات يومياً ومعدل توصيل في الوقت 98%.",
    lessonsLearned: [
      "Real-time order state management is critical in food delivery UX",
      "Maps integration and ETA accuracy directly impact customer retention",
    ],
    lessonsLearnedAr: [
      "إدارة حالة الطلب الفورية حاسمة في تجربة توصيل الطعام",
      "تكامل الخرائط ودقة وقت الوصول يؤثران مباشرة على احتفاظ العملاء",
    ],
    role: "Full Stack Developer",
    roleAr: "مطور Full Stack",
    timeline: "2023 — 2024",
    timelineAr: "2023 — 2024",
    gradient: "from-orange-600/20 via-red-600/10 to-orange-900/20",
    accentColor: "#F97316",
    year: "2023",
    featured: true,
  },
